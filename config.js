module.exports = {
    bot: {
        tokens: [
          "MTM1ODQzMjg4ODM3ODQ5NTE3OQ.GCHh43.y13c47ODST2dfuXJuYz3l2rThIU1QiqeDmvx6g",              // Main bot token - Replace with your actual token
    ...
    server: {
        guildId: '1303842549756072069',         // ايدي السيرفر
        broadcastRoleId: '1353526791305826314', // ايدي الرول اللي يستخدم عليها البوت
        reportChannelId: '1353527534809120859' // ايدي الروم اللي يرسل فيه البوت التقارير
    },
    broadcast: {
